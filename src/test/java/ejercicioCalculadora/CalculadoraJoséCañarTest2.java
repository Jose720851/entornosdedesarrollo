...
class CalculadoraJoséCañarTest2 {
    private CalculadoraJoséCañar calc;
    @BeforeEach
    void setUp() {
        calc = new CalculadoraJoséCañar (20, 10);
    ...
    void testSumaConParametros(int valor) {
        CalculadoraJoséCañar calc = new CalculadoraJoséCañar (valor, 10);
    ...
    void testSumaConVariosValores(int a, int b, int resultadoEsperado) {
        CalculadoraJoséCañar calc = new CalculadoraJoséCañar(a, b);

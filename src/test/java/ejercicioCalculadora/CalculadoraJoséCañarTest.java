...
class CalculadoraJoséCañarTest {
    ...
    void testSuma() {
        ...
        CalculadoraJoséCañar calc = new CalculadoraJoséCañar(20, 10);
    ...
    public void testDivCero() {
        try {
            CalculadoraJoséCañar calc = new CalculadoraJoséCañar(20, 0);
    ...
    @Test
    void testResta2() {
        CalculadoraJoséCañar calc = new CalculadoraJoséCañar(10, 20);
        int valorEsperado = 10;
